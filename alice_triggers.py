...
# trigger strings defined in
# https://github.com/alisw/AliPhysics/blob/master/OADB/macros/BrowseAndFillPhysicsSelectionOADB.C
...
def getINT7TriggerIds(runNumber):
    ...
    if 282008 <= runNumber <= 282441:
        # pp2017_5TeV: kINT7,"+CINT7-B-NOPF-[CENT|FAST]"
        triggerStrings.append("CINT7-B-NOPF-CENT")
        triggerStrings.append("CINT7-B-NOPF-FAST")
    else:
...
def getEMCEGATriggerIds(runNumber):
    ...
    # pp2017_5TeV: kEMCEGA,"+C[EMC7E|DMC7D]G[1|2]-B-NOPF-CENT"
    triggerStrings = []
    if 282008 <= runNumber <= 282441:
